            ...
            child: new Column(
              ...
              children: <Widget>[
                ...
                new Text(
                    "\$" +
                        widget.crypto
                            .formatCurrency(widget.crypto.marketCapUsd)
                            .substring(
                                0,
                                widget.crypto
                                        .formatCurrency(
                                            widget.crypto.marketCapUsd)
                                        .length -
                                    3) +
                        "\n",
                      ...
                      new Stack(
                          ...
                          children: <Widget>[
                            new TextField(
                              ...
                              onChanged: (newValue) {
                                setState(() {
                                  ...
                                  _controllerUSD
                                      .text = (double.parse(cryptoStr) *
                                          double.parse(widget.crypto.priceUsd))
                                      .toString();
                                });
                              },
                            ...
                            new FlatButton(
                                ...
                                child: new Icon(
                                  Icons.clear,
                                  color: Theme.Colors2.appBarGradientEnd,
                                )),
                          ]),
                      new Separator(),
                      new Stack(
                            ...
                            new TextField(
                              ...
                              onChanged: (newValue) {
                                setState(() {
                                  ...
                                  if ((double.parse(usdStr) /
                                              double.parse(
                                                  widget.crypto.priceUsd))
                                          .toString()
                                          .length >=
                                      10) {
                                    _controllerCrypto.text =
                ...
                new Center(
                  child: new FadeInImage(
                    ...
                    image: new NetworkImage(
                        "https://cryptohistory.org/charts/light/" +
                ...
                new Padding(
                  padding: new EdgeInsets.fromLTRB(5.0, 0.0, 5.0, 50.0),
                )
              ],
            ),
          ),
